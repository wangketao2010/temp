...
def main():
    ...
    generator = Generator_BiLSTM_CRF(0.5, 1, batch_size, params, filter_sizes, num_filters, 0.75, length,vocab_file=vocab_file)
    ...
    if args.mode == 'train':
        for epoch_index in range(30):
            ...
            #         #               if index > 70:
            #         #                    break
            #         run_once_train(sess, ele[1][0], ele[1][1], ele[1][2], dev=test_data, epoch=epoch_index,
            #                       gen=generator,
            #                       num_batches=batches_labeled_d_list_len, batch=index, label=2, it=0, iteration=0, saver=saver)
            #         run_once_train(sess, ele2[1][0], ele2[1][1], ele2[1][2], dev=test_data, epoch=epoch_index,
            #                       gen=generator,
            ...
            #             #          print(i)
            #             run_once_train(sess, words, labels, tags=tags, dev=test_data, epoch=epoch_index, gen=generator,
            ...
            #
            # print('epoch {} finished!'.format(epoch_index))
